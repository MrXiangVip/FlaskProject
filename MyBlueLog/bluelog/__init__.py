...
from bluelog.models.models import Post, Category, Comment, Link, Admin
from bluelog.routes.admin import admin_bp
from bluelog.routes.auth import auth_bp
from bluelog.routes.blog import blog_bp
